...
//Graphic
let imgBirdsR = ["count-corona1.png", "count-corona1.png", "count-corona1.png"];
let imgBirdsL = ["count-corona.png", "count-corona.png", "count-corona.png"];
let imgBirdsShot = ["boom.png", "boom.png", "boom.png"];
let imgBirdsDie = ["count-corona2.png", "count-corona2.png", "count-corona2.png"];
...
function loopGame() {
    ...
    if (stageTime == 0) {
        ...
        document.getElementById('stage-output').innerHTML = "Stage " + stageShow;
