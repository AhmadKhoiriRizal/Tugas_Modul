...
function pickGoodImages() {
  ...
  let selectedGoodImages = getRandom(goodImages, 6);
...
function pickBadImages() {
  ...
  let selectedBadImages = getRandom(badImages, 6);
...
function pickImages() {
  ...
  let randomAllImages = getRandom(allImages, 12);
...
const checkGrid = function () {
  if (
    ...
    jQuery("#box7").find(".in_image").length == 1 &&
    jQuery("#box8").find(".in_image").length == 1 &&
    jQuery("#box9").find(".in_image").length == 1 &&
    jQuery("#box10").find(".in_image").length == 1 &&
    jQuery("#box11").find(".in_image").length == 1 &&
    jQuery("#box12").find(".in_image").length == 1 
  ) {
    if (
      ...
      jQuery("#box7").find(".good").length == 1 &&
      jQuery("#box9").find(".good").length == 1 &&
      jQuery("#box11").find(".good").length == 1 &&
      jQuery("#box2").find(".bad").length == 1 &&
      jQuery("#box4").find(".bad").length == 1 &&
      jQuery("#box6").find(".bad").length == 1 &&
      jQuery("#box8").find(".bad").length == 1 &&
      jQuery("#box10").find(".bad").length == 1 &&
      jQuery("#box12").find(".bad").length == 1 
    ) {
      ...
      if (jQuery("#box7").find(".good").length == 1) {
        document.getElementById("box7").classList.add("success_selected");
        $("#box7").append(" <r>&#x2713;</r>");
      } else {
        document.getElementById("box7").classList.add("fail_selected");
        $("#box7").append(" <wr> &#x2717;</wr>");
      }
      if (jQuery("#box9").find(".good").length == 1) {
        document.getElementById("box9").classList.add("success_selected");
        $("#box9").append(" <r>&#x2713;</r>");
      } else {
        document.getElementById("box9").classList.add("fail_selected");
        $("#box9").append(" <wr> &#x2717;</wr>");
      }
      if (jQuery("#box11").find(".good").length == 1) {
        document.getElementById("box11").classList.add("success_selected");
        $("#box11").append(" <r>&#x2713;</r>");
      } else {
        document.getElementById("box11").classList.add("fail_selected");
        $("#box11").append(" <wr> &#x2717;</wr>");
      }
      ...
      if (jQuery("#box8").find(".good").length == 1) {
        document.getElementById("box8").classList.add("fail_selected");
        $("#box8").append(" <wr> &#x2717;</wr>");
      } else {
        document.getElementById("box8").classList.add("success_selected");
        $("#box8").append(" <r>&#x2713;</r>");
      }
      if (jQuery("#box10").find(".good").length == 1) {
        document.getElementById("box10").classList.add("fail_selected");
        $("#box10").append(" <wr> &#x2717;</wr>");
      } else {
        document.getElementById("box10").classList.add("success_selected");
        $("#box10").append(" <r>&#x2713;</r>");
      }
      if (jQuery("#box12").find(".good").length == 1) {
        document.getElementById("box12").classList.add("fail_selected");
        $("#box12").append(" <wr> &#x2717;</wr>");
      } else {
        document.getElementById("box12").classList.add("success_selected");
        $("#box12").append(" <r>&#x2713;</r>");
      }
